...
typedef struct celeg_engine_model_options {
    uint32_t struct_size;
    celeg_backend backend;
    int32_t max_context;
    union { celeg_cpu_model_config cpu; celeg_cuda_model_options cuda; } backend_options;
    celeg_generation_options generation;
} celeg_engine_model_options;
...
typedef struct celeg_engine_options {
    uint32_t struct_size;
    celeg_backend backend;
    union { celeg_cpu_engine_options cpu; celeg_cuda_engine_options cuda; } backend_options;
