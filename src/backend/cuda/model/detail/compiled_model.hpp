...
#include "backend/cuda/decode_graphs.hpp"
#include "backend/cuda/workspace.hpp"
#include "backend/cuda/packed/session.hpp"
...
struct CudaCompiledModel {
    ...
    void enqueue_decode_attention(Layer& layer, int layer_index);
    ...
    void enqueue_decode_factorized_latent_attention(Layer& layer, int layer_index);
