...
| Type | Ordinal | Block | Bytes | CPU dequant | CPU native dot | CUDA dequant | CUDA native MMQ | Metal native |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| IQ3_S | 21 | 256 | 110 | complete | reference only | complete | not planned* | host fallback |
| IQ2_S | 22 | 256 | 82 | complete | reference only | complete | not planned* | host fallback |
| IQ4_XS | 23 | 256 | 136 | complete | reference only | complete | not planned* | host fallback |
